...
from Handlers import (cmd_start, gista_course, cq_contacts, cq_courses, cq_individual_courses,
                      ...
                      time_link, guide_v2, ai_for_med, conf_for_med)
from Bot import bot
...
async def main():
    ...
    dp.include_routers(guide_v2.router, cmd_start.router, gista_course.router, cq_contacts.router,
                       ...
                       nervnaya_sys.router, okraski.router, callback.router, links_generator.router, time_link.router, ai_for_med.router, conf_for_med.router)
