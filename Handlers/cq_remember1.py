...
from texts.all_texts import remember1_txt
...
@router.callback_query(F.data == 'remember1')
async def get_contacts(callback: types.CallbackQuery):
    ...
    await callback.message.edit_text(remember1_txt, reply_markup=builder.as_markup())
